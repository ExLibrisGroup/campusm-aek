...
inputBackground = rgb(255, 255, 255, 1)
inputBorder = 1px solid borderColor
inputBorderRadius = absoluteBorderRadius
inputColor = textColor
inputTransition = background-color 0.2s ease, color 0.2s ease, box-shadow 0.2s ease, border-color 0.2s ease
...
/* Dropdown Error */
dropdownErrorHoverBackground = rgb(251, 231, 231, 1)
dropdownErrorActiveBackground = rgb(253, 207, 207, 1)
/* Focused Error */
