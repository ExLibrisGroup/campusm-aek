...
// backgroundColor = rgb(232, 232, 232, 1)
...
// imageLabelImageMargin = - verticalPadding verticalPadding imageLabelTextDistance - verticalPadding verticalPadding - imageLabelTextDistance imageLabelTextDistance
// imageLabelDetailPadding = imageLabelVerticalPadding imageLabelHorizontalPadding
// imageLabelDetailMargin = - imageLabelVerticalPadding imageLabelVerticalPadding - imageLabelHorizontalPadding imageLabelHorizontalPadding - imageLabelVerticalPadding imageLabelVerticalPadding imageLabelDetailDistance

/*-------------------
        States
--------------------*/
// labelHoverBackgroundColor = rgb(224, 224, 224, 1)
...
/* Tag */
// tagCircleColor = rgb(255, 255, 255, 1)
// tagCircleSize = 0.5em
...
// ribbonDistance = unquote("calc(") ribbonMargin unquote(" + ") ribbonTriangleSize unquote(")")
// rightRibbonOffset = unquote("calc(100% + ") ribbonMargin unquote(" + ") ribbonTriangleSize unquote(")")
...
// ribbonImageDistance = unquote("calc(") ribbonImageMargin unquote(" + ") ribbonTriangleSize unquote(")")
// rightRibbonImageOffset = unquote("calc(100% + ") ribbonImageMargin unquote(" + ") ribbonTriangleSize unquote(")")
