...
huge = 4em
massive = 8em
fallbackSRC = "@{fontPath}/@{fontName}.eot"
src = "@{fontPath}/@{fontName}.eot?#iefix" format('embedded-opentype'), "@{fontPath}/@{fontName}.woff2" format('woff'), "@{fontPath}/@{fontName}.woff" format('woff'), "@{fontPath}/@{fontName}.ttf" format('truetype'), "@{fontPath}/@{fontName}.svg#icons" format('svg')
