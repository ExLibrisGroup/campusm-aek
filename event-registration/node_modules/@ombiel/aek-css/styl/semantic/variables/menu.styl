...
itemBackground = none
fontWeight = normal
boxShadow = 0px 0px 0px 1px borderColor, subtleShadow
borderSize = 0em
transition = opacity 0.2s ease, background 0.2s ease, box-shadow 0.2s ease
borderRadius = defaultBorderRadius
dividerSize = 1px
dividerBackground = linear-gradient(rgba(0, 0, 0, 0.05) 0%, rgba(0, 0, 0, 0.1) 50%, rgba(0, 0, 0, 0.05) 100%)
...
/* Dropdown */
dropdownBackground = rgb(255, 255, 255, 1)
...
arrowZIndex = 11
arrowHoverColor = rgb(250, 250, 250, 1)
arrowActiveColor = rgb(247, 247, 247, 1)
...
---------------*/
/* Vertical */
verticalBackground = rgb(255, 255, 255, 1)
verticalItemBackground = none
verticalDividerBackground = linear-gradient(to right, rgba(0, 0, 0, 0.03) 0%, rgba(0, 0, 0, 0.1) 1.5em, rgba(0, 0, 0, 0.03) 100%)
/* Secondary */
...
/* Tiered */
tieredActiveItemBackground = rgb(252, 252, 252, 1)
tieredActiveMenuBackground = rgb(252, 252, 252, 1)
...
invertedDividerBackground = linear-gradient(rgba(255, 255, 255, 0.03) 0%, rgba(255, 255, 255, 0.1) 50%, rgba(255, 255, 255, 0.03) 100%)
invertedVerticalDividerBackground = linear-gradient(to right, rgba(255, 255, 255, 0.03) 0%, rgba(255, 255, 255, 0.1) 50%, rgba(255, 255, 255, 0.03) 100%)
/* Fixed */
fixedGridMargin = 2.75rem
/* Attached */
attachedBoxShadow = 0px 0px 0px 1px rgb(221, 221, 221, 1)
/* Sizes */
small = 0.875rem
