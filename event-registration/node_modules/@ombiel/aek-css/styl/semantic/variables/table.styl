...
borderSpacing = 0px
transition = background transitionDuration transitionEasing, border-color transitionDuration transitionEasing, color transitionDuration transitionEasing
borderRadius = 0.25rem
background = rgb(255, 255, 255, 1)
color = textColor
borderWidth = 1px
borderColor = rgb(208, 208, 208, 1)
...
responsiveRowBoxShadow = 0px -1px 0px 0px rgba(0, 0, 0, 0.1) inset
...
activeBackgroundColor = rgb(224, 224, 224, 1)
activeBoxShadow = stateMarkerWidth 0px 0px activeColor inset
activeBackgroundHover = rgb(239, 239, 239, 1)
...
attachedTableWidth = unquote("calc(100% + ") (attachedHorizontalOffset * -2) unquote(")")
/* Striped */
...
/* Inverted */
invertedBackground = rgb(51, 51, 51, 1)
invertedBorder = none
