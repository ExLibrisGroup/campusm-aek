...
checkboxTransition = background-color 0.3s ease, border 0.3s ease, box-shadow 0.3s ease
/* Checkmark */
...
checkboxSelectedBackground = rgb(245, 245, 245, 1)
...
handleBoxShadow = subtleShadow, 0px 0px 0px 1px borderColor inset
/* Slider */
...
toggleHandleTransition = background 0.3s ease 0s, left 0.3s ease 0s
