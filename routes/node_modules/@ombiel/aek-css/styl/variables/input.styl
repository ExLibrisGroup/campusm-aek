...
// transition = background-color transitionDuration transitionEasing, box-shadow transitionDuration transitionEasing, border-color transitionDuration transitionEasing
...
// downBackground = rgb(250, 250, 250, 1)
// downColor = textColor
// downBoxShadow = none
