...
// boxShadow = borderShadow, subtleShadow
// verticalPadding = 1em
...
/* Loading Spinner */
// loaderSize = 3em
// loaderOffset = - (loaderSize / 2) (loaderSize / 2)
...
// raisedBoxShadow = borderShadow, raisedShadow

/* Attached */
// attachedTopOffset = 0px
// attachedBottomOffset = 0px
// attachedHorizontalOffset = -1px
// attachedWidth = unquote("calc(100% + ") (- attachedHorizontalOffset attachedHorizontalOffset * 2) unquote(")")
...
/* Ordinality */
// secondaryBackground = rgb(250, 249, 250, 1)
// secondaryColor = textColor
// tertiaryBackground = rgb(235, 235, 235, 1)
