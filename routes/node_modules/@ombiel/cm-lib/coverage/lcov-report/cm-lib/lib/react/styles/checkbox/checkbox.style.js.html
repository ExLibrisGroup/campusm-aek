...
<html lang="en">
<head>
    <title>Code coverage report for cm-lib/lib/react/styles/checkbox/checkbox.style.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../../index.html">All files</a> / <a href="index.html">cm-lib/lib/react/styles/checkbox</a> checkbox.style.js
    </h1>
    <div class='clearfix'>
...
710
711
712</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
// import {unitMath,applyUnitIfRequired} from "../../../utils/css-utils";
...
&nbsp;
    ...
    checkboxPressedColor,
    checkboxSize,
    checkboxTransition,
    disabledCheckboxLabelColor,
    disabledCheckboxOpacity,
    handleBackground,
    handleBoxShadow,
    // labelActiveColor,
    labelColor,
    ...
    sliderLineVerticalOffset,
    sliderLineWidth,
    sliderOffLabelColor,
    sliderOnFocusLabelColor,
    sliderOnFocusLineColor,
    sliderOnLabelColor,
    sliderOnLineColor,
    ...
    toggleHoverColor,
    toggleLabelDistance,
    // toggleLabelLineHeight,
    toggleLabelOffset,
    toggleLaneBackground,
    toggleLaneBoxShadow,
    toggleLaneHeight,
    toggleLaneVerticalOffset,
    toggleLaneWidth,
    toggleOffHandleBoxShadow,
    toggleOffLabelColor,
    toggleOffOffset,
    toggleOnFocusLabelColor,
    toggleOnFocusLaneColor,
...
&nbsp;
  return flaggedStyles("checkbox", flags, {
&nbsp;
    _: () =&gt; (css`
&nbsp;
...
&nbsp;
      ...
      &amp; input:not([type=radio]):indeterminate ~ label:after {
...
&nbsp;
    ...
    `),
&nbsp;
    readOnly: <span class="fstat-no" title="function not covered" >()</span>=&gt;(<span class="cstat-no" title="statement not covered" >css`</span>
&nbsp;
      &amp;,
      &amp; label {
        cursor: default;
...
&nbsp;
    ...
    radio: <span class="fstat-no" title="function not covered" >()</span>=&gt;(<span class="cstat-no" title="statement not covered" >css`</span>
...
&nbsp;
    `),
&nbsp;
    slider: <span class="fstat-no" title="function not covered" >()</span>=&gt;(<span class="cstat-no" title="statement not covered" >css`</span>
...
&nbsp;
    `),
&nbsp;
    toggle: <span class="fstat-no" title="function not covered" >()</span>=&gt;(<span class="cstat-no" title="statement not covered" >css`</span>
&nbsp;
...
&nbsp;
    `),
&nbsp;
    fitted: <span class="fstat-no" title="function not covered" >()</span>=&gt;(<span class="cstat-no" title="statement not covered" >css`</span>
&nbsp;
      &amp; label {
        padding-left: 0em ;
      }
    `),
&nbsp;
    "fitted,toggle": <span class="fstat-no" title="function not covered" >()</span>=&gt;(<span class="cstat-no" title="statement not covered" >css`</span>
      width: ${toggleWidth};
    `),
&nbsp;
    "fitted,slider": <span class="fstat-no" title="function not covered" >()</span> =&gt; (<span class="cstat-no" title="statement not covered" >css`</span>
      width: ${sliderWidth};
    `),
&nbsp;
