...
<html lang="en">
<head>
    <title>Code coverage report for cm-lib/lib/react/styles/form/form.var.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../../index.html">All files</a> / <a href="index.html">cm-lib/lib/react/styles/form</a> form.var.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
import {unitMath,lighten} from "../../../utils/css-utils";
&nbsp;
...
&nbsp;
  const rowDistance = "1em";
  const gutterWidth = "1em";
&nbsp;
  const labelDistance = getSize(4);
  const labelFontSize = getRelativeSize("small");
  const labelFontWeight = "bold";
  const labelColor = textColor;
&nbsp;
  const inputBorder = `1px solid ${borderColor}`;
  const inputBorderRadius = absoluteBorderRadius;
  const inputColor = textColor;
  const inputBoxShadow = "0em 0em 0em 0em transparent inset";
  const inputFontSize = "1em";
&nbsp;
  const labelTextTransform = "none";
&nbsp;
  const formErrorColor = getTextColor("negative");
  const formErrorBorder = getBorderColor("negative");
  const formErrorBackground = getBackgroundColor("negative");
&nbsp;
  const inputFocusPointerSize = "0px";
&nbsp;
&nbsp;
  const inputFocusBackground = inputBackground;
  const inputFocusBorderColor = focusedFormBorderColor;
  const inputFocusColor = selectedTextColor;
  const inputFocusBoxShadow = `${inputFocusPointerSize} 0em 0em 0em ${selectedBorderColor} inset`;
  const inputFocusBorderRadius = inputBorderRadius;
&nbsp;
  const inputAutoFillBackground = "#FFFFF0";
&nbsp;
  const requiredVerticalOffset = "-0.2em";
  const requiredDistance = "0.2em";
&nbsp;
