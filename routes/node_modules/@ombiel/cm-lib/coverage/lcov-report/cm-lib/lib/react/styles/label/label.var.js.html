...
<html lang="en">
<head>
    <title>Code coverage report for cm-lib/lib/react/styles/label/label.var.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../../index.html">All files</a> / <a href="index.html">cm-lib/lib/react/styles/label</a> label.var.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  const verticalPadding = "0.5833em"; /* medium is not @emSize custom value required */
  const backgroundColor = "#E8E8E8";
  const horizontalPadding = "0.833em";
  const basicBorder = `1px solid ${borderColor}`;
&nbsp;
  const ribbonTriangleSize = "1.2em";
  const ribbonMargin = "1rem";
