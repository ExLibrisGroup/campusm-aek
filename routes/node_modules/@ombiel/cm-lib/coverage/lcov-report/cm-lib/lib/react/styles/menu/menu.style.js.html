...
<html lang="en">
<head>
    <title>Code coverage report for cm-lib/lib/react/styles/menu/menu.style.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../../index.html">All files</a> / <a href="index.html">cm-lib/lib/react/styles/menu</a> menu.style.js
    </h1>
    <div class='clearfix'>
...
1325
1326
1327</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    /* Vertical Menu */
    "vertical,bigIcon": <span class="fstat-no" title="function not covered" >()</span>=&gt;(<span class="cstat-no" title="statement not covered" >css`</span>
...
&nbsp;
    inverted: ()=&gt;(css`
      ...
      background: ${variation ? getInvertedBackgroundColor(variation) : invertedBackground};
...
&nbsp;
  if (size) {
    const menuSize = menuSizes[size];
    <span class="missing-if-branch" title="if path not taken" >I</span>if (menuSize) {
