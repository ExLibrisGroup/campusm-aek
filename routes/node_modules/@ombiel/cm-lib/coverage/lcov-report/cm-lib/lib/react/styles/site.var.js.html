...
<html lang="en">
<head>
    <title>Code coverage report for cm-lib/lib/react/styles/site.var.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">All files</a> / <a href="index.html">cm-lib/lib/react/styles</a> site.var.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  function getBackgroundColor(variation) {
    const varColor = isString(variation) 
      ...
      : get(variation,"backgroundColor");
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (varColor) { <span class="cstat-no" title="statement not covered" >return varColor; </span>}
&nbsp;
    const baseColor = getBaseColor(variation);
    
    if (!baseColor &amp;&amp; defaultBackgroundColors[variation]) {
      return defaultBackgroundColors[variation];
    }
...
&nbsp;
  ...
  const pageFont = getAekConfig("style.pageFont",
    `-apple-system,BlinkMacSystemFont,"Segoe UI",Helvetica,Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol"`);
  const headerLineHeight = `${18 / 14}em`;
  const headerLineHeightOffset = unitMath(unitMath(headerLineHeight, "-", "1em"), "/", 2);
&nbsp;
...
&nbsp;
    ...
    pageFont,
    headerFont: getAekConfig("style.headerFont",pageFont),
    fontSize: "14px",
    //
