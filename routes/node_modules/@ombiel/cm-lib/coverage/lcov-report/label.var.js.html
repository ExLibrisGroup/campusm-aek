...
<html lang="en">
<head>
    <title>Code coverage report for label.var.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> label.var.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  const verticalPadding = <span class="cstat-no" title="statement not covered" >"0.5833em"; /* medium is not @emSize custom value required */</span>
  const backgroundColor = <span class="cstat-no" title="statement not covered" >"#E8E8E8";</span>
  const horizontalPadding = <span class="cstat-no" title="statement not covered" >"0.833em";</span>
  const basicBorder<span class="cstat-no" title="statement not covered" > = `1px solid ${borderColor}`;</span>
&nbsp;
  const ribbonTriangleSize = <span class="cstat-no" title="statement not covered" >"1.2em";</span>
  const ribbonMargin = <span class="cstat-no" title="statement not covered" >"1rem";</span>
    
<span class="cstat-no" title="statement not covered" >  return extend({}, siteVars, {</span>
    
    verticalAlign: "baseline",
    verticalMargin: 0,
    horizontalMargin: getRelativeSize(2),
    backgroundColor,
...
&nbsp;
    // /* Basic */
    basicBackground: "none #fff",
    basicBorderWidth: "1px",
    basicBorder,
    basicColor: textColor,
    basicBoxShadow: "none",
&nbsp;
    basicHoverBackground: "none #fff",
    basicHoverColor: linkHoverColor,
    basicHoverBorder: basicBorder,
    basicHoverBoxShadow: "none",
&nbsp;
    // /* Tag */
    tagCircleColor: "#fff",
    tagCircleSize: "0.5em",
    tagHorizontalPadding: "1.5em",
    tagCircleBoxShadow: "1px 1px 0 rgba(0, 0, 0, 0.3)", // 0 - 1px 1px 0 rgba(0, 0, 0, 0.3),
...
&nbsp;
    ...
    ribbonImageOffset: `calc(0.05rem - ${ribbonTriangleSize})`,
    rightRibbonImageOffset: `calc(100% - 0.05rem + ${ribbonTriangleSize})`,
&nbsp;
...
&nbsp;
    attachedCornerBorderRadius: getSize(3),
    attachedBorderRadius: absoluteBorderRadius,
&nbsp;
    // /* Corner */
    cornerSizeRatio: 1,
    ...
    cornerIconSize: getRelativeSize("large"),
    cornerIconTopOffset: getRelativeSize(9),
    cornerIconLeftOffset: getRelativeSize(11),
&nbsp;
    // /* Corner Text */
    cornerTextWidth: "3em",
