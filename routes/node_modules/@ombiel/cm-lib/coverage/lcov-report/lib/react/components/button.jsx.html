...
<html lang="en">
<head>
    <title>Code coverage report for lib/react/components/button.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">lib/react/components</a> button.jsx
    </h1>
    <div class='clearfix'>
...
import buttonStyle from "../styles/button/button.style";
import buttonVariation from "../styles/button/button-variation.style";
...
&nbsp;
  // variations
  if (props.variation) {
    classSet[buttonVariation(props.variation)] = true;
  }
&nbsp;
  // // social
...
&nbsp;
  ...
  if (props.icon) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (isFunction(props.icon) || isString(props.icon)) {
      iconElement = &lt;Icon icon={props.icon} /&gt;;
    }
