...
<html lang="en">
<head>
    <title>Code coverage report for menu.style.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> menu.style.js
    </h1>
    <div class='clearfix'>
...
1330
1331
1332</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
import getMenuItemStyles from "./menu-item.style";
&nbsp;
export default styleMemoize(function(flags = <span class="branch-0 cbranch-no" title="branch not covered" >[],</span>variation,size) {
&nbsp;
...
&nbsp;
  const vColor = variation &amp;&amp; getColor(variation);
&nbsp;
  let styles = flaggedStyles(flags,{
    /*--------------
        Menu
    ---------------*/
    _: ()=&gt;(css`
...
&nbsp;
      &amp;&gt;*,&amp;&gt;.item {
        ${getMenuItemStyles(flags,variation,size)}
      }
&nbsp;
      display: flex;
      margin: ${margin};
...
&nbsp;
    inverted: ()=&gt;(css`
      ...
      background: ${vColor || invertedBackground};
...
&nbsp;
    /* Tabular Attached */
    "attached,!tabular": <span class="fstat-no" title="function not covered" >()</span>=&gt;(<span class="cstat-no" title="statement not covered" >css`</span>
      border: ${attachedBorder};
    `),
    "attached,inverted": <span class="fstat-no" title="function not covered" >()</span>=&gt;(<span class="cstat-no" title="statement not covered" >css`</span>
      border: none;
    `),
    "attached,tabular": <span class="fstat-no" title="function not covered" >()</span>=&gt;(<span class="cstat-no" title="statement not covered" >css`</span>
      margin-left: 0;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (size) {
    const menuSize = <span class="cstat-no" title="statement not covered" >menuSizes[size];</span>
<span class="cstat-no" title="statement not covered" >    if (menuSize) {</span>
      const [fontSize,width] = <span class="cstat-no" title="statement not covered" >menuSizes;</span>
      const fStyles = <span class="cstat-no" title="statement not covered" >flaggedStyles(flags,{</span>
        _: <span class="fstat-no" title="function not covered" >()</span> =&gt; (<span class="cstat-no" title="statement not covered" >css`</span>
          font-size: ${fontSize};
        `),
...
<span class="cstat-no" title="statement not covered" >      styles = css`</span>
        ${styles}
        ${fStyles}
      `;
    }
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Wed Jan 16 2019 20:03:09 GMT+0000 (GMT)
</div>
</div>
