...
<html lang="en">
<head>
    <title>Code coverage report for react/styles/form/form.style.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">react/styles/form</a> form.style.js
    </h1>
    <div class='clearfix'>
...
1047
1048
1049</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
&nbsp;
  return flaggedStyles(`${sizeName}-form`, flags, {
&nbsp;
    _: () =&gt; (css`
&nbsp;
      position: relative;
      max-width: 100%;
      fontSize: ${getSize(sizeName)};
...
&nbsp;
    ...
    // }
&nbsp;
    loading: <span class="fstat-no" title="function not covered" >()</span>=&gt;(<span class="cstat-no" title="statement not covered" >`css</span>
...
&nbsp;
        ...
        height: ${loaderSize};
&nbsp;
        animation: ${formSpin} ${loaderSpeed} linear;
