...
<html lang="en">
<head>
    <title>Code coverage report for react/styles/label/label.style.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">react/styles/label</a> label.style.js
    </h1>
    <div class='clearfix'>
...
import { darken, makeReadable, unitMath } from "../../../utils/css-utils";
import styleMemoize from "../../../utils/style-memoize";
import flaggedStyles from "../../../utils/flagged-styles";
import getLabelVars from "./label.var";
&nbsp;
&nbsp;
export default styleMemoize(function (flags = <span class="branch-0 cbranch-no" title="branch not covered" >[],</span> variation, sizeName) {
&nbsp;
  const labelVars = getLabelVars();
&nbsp;
  const {
    getSize,
    getAbsoluteSize,
...
&nbsp;
  if (variation) {
    ...
    vTextColor = firstReadableColor(vColor, ["#fff", makeReadable(vColor, vColor)]);
    vTextColorBasic = getTextColor(variation);
    vHoverColor = getHoverColor(variation);
  }
&nbsp;
&nbsp;
  const fontSize = sizes[sizeName];
&nbsp;
  // eslint-disable-next-line no-nested-ternary
  const variationName = isString(variation) ? variation : (variation ? "custom" : "normal");
&nbsp;
  return flaggedStyles(`${sizeName}-${variationName}-label`, flags, {
&nbsp;
    _: () =&gt; (css`
...
&nbsp;
    `),
&nbsp;
    "tag,basic": <span class="fstat-no" title="function not covered" >()</span> =&gt; (<span class="cstat-no" title="statement not covered" >css`</span>
...
&nbsp;
    ...
    `),
&nbsp;
    "attached,bottom,left": <span class="fstat-no" title="function not covered" >()</span> =&gt; (<span class="cstat-no" title="statement not covered" >css`</span>
...
&nbsp;
    ...
    `),
&nbsp;
    active: <span class="fstat-no" title="function not covered" >()</span>=&gt;(<span class="cstat-no" title="statement not covered" >css`</span>
&nbsp;
...
&nbsp;
    ...
    basic: <span class="fstat-no" title="function not covered" >()</span>=&gt;(<span class="cstat-no" title="statement not covered" >css`</span>
...
&nbsp;
    ...
    fluid: <span class="fstat-no" title="function not covered" >()</span>=&gt;(<span class="cstat-no" title="statement not covered" >css`</span>
      width: 100%;
      box-sizing: border-box;
    `),
&nbsp;
    inverted: <span class="fstat-no" title="function not covered" >()</span>=&gt;(<span class="cstat-no" title="statement not covered" >css`</span>
...
&nbsp;
&nbsp;
    circular: <span class="fstat-no" title="function not covered" >()</span>=&gt;(<span class="cstat-no" title="statement not covered" >css`</span>
...
&nbsp;
    ...
    "pointing,attached": <span class="fstat-no" title="function not covered" >()</span>=&gt;(<span class="cstat-no" title="statement not covered" >css`</span>
      position: absolute;
    `),
&nbsp;
    pointingUp: ()=&gt;(css`
...
&nbsp;
    ...
    `),
&nbsp;
    "pointingUp,basic": <span class="fstat-no" title="function not covered" >()</span>=&gt;(<span class="cstat-no" title="statement not covered" >css`</span>
      &amp;:before {
        margin-top: ${basicPointingTriangleOffset};
      }
    `),
&nbsp;
    "pointingDown,basic": <span class="fstat-no" title="function not covered" >()</span> =&gt; (<span class="cstat-no" title="statement not covered" >css`</span>
      &amp;:before {
        bottom: auto;
        top: 100%;
        margin-top: -${basicPointingTriangleOffset};
    ...
    "pointingLeft,basic": <span class="fstat-no" title="function not covered" >()</span> =&gt; (<span class="cstat-no" title="statement not covered" >css`</span>
      &amp;:before {
        top: 50%;
    ...
    `),
&nbsp;
    "pointingRight,basic": <span class="fstat-no" title="function not covered" >()</span> =&gt; (<span class="cstat-no" title="statement not covered" >css`</span>
      &amp;:before {
        top: 50%;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Sun Jan 20 2019 02:38:19 GMT+0000 (GMT)
</div>
</div>
