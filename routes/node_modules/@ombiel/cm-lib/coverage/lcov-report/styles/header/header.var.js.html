...
<html lang="en">
<head>
    <title>Code coverage report for styles/header/header.var.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">styles/header</a> header.var.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  const iconMargin = "0.75rem";
&nbsp;
  const headerNamedSizes = {
    huge: headerSizes.h1,
    large: headerSizes.h2,
    medium: headerSizes.h3,
    small: headerSizes.h4,
    tiny: headerSizes.h5,
  };
&nbsp;
...
&nbsp;
  const subHeaderNamedSizes = {
    huge: subHeaderSizes.h1,
    large: subHeaderSizes.h2,
    medium: subHeaderSizes.h3,
    small: subHeaderSizes.h4,
    tiny: subHeaderSizes.h5,
  };
...
&nbsp;
    ...
    margin: `${headerTopMargin} 0em ${headerBottomMargin}`,
&nbsp;
    firstMargin: `-${headerLineHeightOffset}`,
    lastMargin: "0em",
    horizontalPadding: "0em",
    verticalPadding: "0em",
&nbsp;
    /* Sub Heading */
    subHeadingDistance: getSize(2),
    subHeadingFontSize: getRelativeSize("tiny"),
    subHeadingFontWeight: "bold",
    subHeadingTextTransform: "uppercase",
    subHeadingColor: '',
&nbsp;
    smallSubHeadingSize: getRelativeSize("mini"),
    largeSubHeadingSize: getRelativeSize("small"),
    hugeSubHeadingSize: getRelativeSize("medium"),
&nbsp;
    /* Sub Header */
    subHeaderMargin: "0em",
...
&nbsp;
    ...
    imageWidth: "2.5em",
    imageHeight: "auto",
    imageOffset: headerLineHeightOffset,
...
&nbsp;
    dividedBorderPadding: getSize(3),
    dividedSubHeaderPadding: getSize(3),
...
&nbsp;
    ...
    blockHorizontalPadding: getSize("medium"),
    blockVerticalPadding: getSize("mini"),
...
&nbsp;
    ...
    attachedVerticalPadding: getSize("mini"),
    attachedHorizontalPadding: getSize("medium"),
    attachedBackground: "#fff",
    attachedBorderRadius: defaultBorderRadius,
&nbsp;
...
&nbsp;
    ...
    invertedBlockBackground: `${getLightColor("black")} ${subtleGradient}`,
    invertedAttachedBackground: `${getLightColor("black")} ${subtleGradient}`,
&nbsp;
    /* Floated */
    floatedMargin: "0.5em",
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Sat Jan 26 2019 01:21:02 GMT+0000 (GMT)
</div>
</div>
