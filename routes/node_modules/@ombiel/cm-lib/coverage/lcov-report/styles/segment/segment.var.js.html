...
<html lang="en">
<head>
    <title>Code coverage report for styles/segment/segment.var.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">styles/segment</a> segment.var.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  const verticalPadding = "1em";
  const horizontalPadding = "1em";
  const padding = `${verticalPadding} ${horizontalPadding}`;
&nbsp;
  const verticalMargin = "1rem";
  const horizontalMargin = "0em";
  const margin = `${verticalMargin} ${horizontalMargin}`;
&nbsp;
  const attachedHorizontalOffset = `-${borderWidth}`;
&nbsp;
  const boxShadow = subtleShadow;
&nbsp;
  const secondaryInvertedLightness = 0.2;
  const tertiaryInvertedLightness = 0.35;
...
&nbsp;
    ...
    groupedBoxShadow: subtleShadow,
    groupedBorderRadius: defaultBorderRadius,
&nbsp;
...
&nbsp;
    /* Page Grid Segment */
    pageGridMargin: unitMath(2,"*",verticalPadding),
&nbsp;
    /*******************************
                Types
    *******************************/
...
&nbsp;
    ...
    stackedPadding: unitMath(verticalPadding,"+","0.4em"),
    tallStackedPadding: unitMath(verticalPadding,"+","0.8em"),
&nbsp;
    /*******************************
                States
    *******************************/
...
&nbsp;
    ...
    attachedWidth: `calc(100% - ${unitMath(attachedHorizontalOffset,"*",2)})`,
    attachedBoxShadow: "none",
    attachedBorder: `${borderWidth} solid ${solidBorderColor}`,
    attachedBottomBoxShadow: `${boxShadow}, none`,
